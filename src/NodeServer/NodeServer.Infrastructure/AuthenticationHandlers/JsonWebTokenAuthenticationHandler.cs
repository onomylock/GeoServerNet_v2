            ...
            foreach (var authorizationBearerPayloadTemp in authorizationBearerPayloads)
                try
                {
                    var uriBuilder = new UriBuilder(
                        nodeServerOptions.Value.MasterServerJsonWebTokenAuthenticationChannel.Scheme,
                        nodeServerOptions.Value.MasterServerJsonWebTokenAuthenticationChannel.Host,
                        nodeServerOptions.Value.MasterServerJsonWebTokenAuthenticationChannel.Port,
                        nodeServerOptions.Value.MasterServerJsonWebTokenAuthenticationChannel.Path);
