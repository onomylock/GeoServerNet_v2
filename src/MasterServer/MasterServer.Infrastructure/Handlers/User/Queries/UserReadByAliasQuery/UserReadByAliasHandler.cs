...
public class UserReadByAliasHandler(
    ...
    IUserGroupEntityService userGroupEntityService) : IRequestHandler<UserReadByAliasQuery, ResponseBase<UserReadResultDto>>
{
    public async Task<ResponseBase<UserReadResultDto>> Handle(UserReadByAliasQuery request, CancellationToken cancellationToken)
    {
